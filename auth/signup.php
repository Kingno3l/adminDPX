            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4 justify-content-center"><span class="text-muted fw-light">Caller ME
                                /</span> SignUp Page</h4>
                        <div class="row">
                            <!-- Basic -->
                            <div class="col-md-8">
                                <div class="card mb-4 shadow">
                                    <h5 class="card-header mx-auto">Sign UP</h5>
                                    <div class="card-body demo-vertical-spacing demo-only-element">
                                        ...
                                        <div>
                                            <input type="number" class="form-control" id="defaultFormControlInput"
                                                placeholder="Phone" aria-describedby="defaultFormControlHelp" />
                                        </div>
                    ...
                    <footer class="content-footer footer bg-footer-theme">
                        <div class="container-xxl d-flex flex-wrap py-2 flex-md-row flex-column">
                            <div class="mb-2 mb-md-0 ">
                                ...
                                , made with ❤️ by
                                <a href="digitalplanetx.tech" target="_blank"
                                    class="footer-link fw-bolder">Digital Planet X</a>
                            </div>
